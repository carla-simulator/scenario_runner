...
namespace traffic_manager {
  ...
  class PipelineCallable {
    ...
    /// This is the base class for thread executables to be run in pipeline
    /// stages.
  ...
  protected:
    ...
    /// This method should be overridden in the child class to provide stage
    /// specific
  ...
  public:
    ...
    /// This method has the logic to co-ordinate reading message from previous
    /// stage,
    /// passing it to action() method, and writing the output message to the
    /// output queue.
