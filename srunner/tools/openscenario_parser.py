...
class OpenScenarioParser(object):
    ...
    def get_catalog_entry(catalogs, catalog_reference):
        ...
        """
        catalog_name = str(ParameterRef(catalog_reference.attrib.get("catalogName")))
        catalog_entry = str(ParameterRef(catalog_reference.attrib.get("entryName")))
    ...
    def get_weather_from_env_action(xml_tree, catalogs):
        ...
        if str(ParameterRef(precepitation.attrib.get('precipitationType'))) == "rain":
        ...
        elif str(ParameterRef(precepitation.attrib.get('type'))) == "snow":
    ...
    def get_controller(xml_tree, catalogs):
        ...
        for prop in properties:
            if str(ParameterRef(prop.attrib.get('name'))) == "module":
    ...
    def convert_position_to_transform(position, actor_list=None):
        ...
        if position.find('WorldPosition') is not None:
            ...
            obj = str(ParameterRef(rel_pos.attrib.get('entityRef')))
            obj_actor = None
