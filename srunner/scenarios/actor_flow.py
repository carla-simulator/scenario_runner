...
class MergerIntoSlowTraffic(BasicScenario):
    ...
    This scenario works when Background Activity is running in route mode. And applies to a confluence area at a highway intersection.
    """
    ...
    def _create_behavior(self):
        ...
        end_condition = py_trees.composites.Sequence()
        end_condition.add_child(InTriggerDistanceToLocation(self.ego_vehicles[0], sink_wp.transform.location, self._sink_distance))
        root.add_child(end_condition)
