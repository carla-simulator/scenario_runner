...
TURNING_RIGHT_SIGNALIZED_JUNCTIONS_SCENARIOS = [
    "TurningRightAtSignals"
]


class TurningRightAtSignals(BasicScenario):
    ...
    def __init__(self, world, ego_vehicle, other_actors, town, randomize=False, debug_mode=False, config=None):
        ...
        self._ego_expected_driven_distance = 88   # Expected driven distance [m]
        self._ego_distance_to_traffic_light = 53  # Trigger distance to traffic light [m]
        self._ego_distance_to_drive = 35          # Allowed distance to drive

        # other vehicle
        self._other_actor_target_velocity = 15      # Target velocity of other vehicle
        self._other_actor_max_brake = 1.0           # Maximum brake of other vehicle
        self._other_actor_distance = 30             # Distance the other vehicle should drive

        _traffic_light = None

        super(TurningRightAtSignals, self).__init__("HeroActorTurningRightAtSignalizedJunctions",
                                                    ego_vehicle,
                                                    other_actors,
                                                    town,
                                                    world,
