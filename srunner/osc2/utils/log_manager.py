...
def LOG_DEBUG(msg, token=None, line=None, column=None):
    if token is not None:
        ...
        msg = '[Debug] file "' + file_path + '", line ' + str(line) + ':' + str(token.column) + ', ' + msg
    elif line is not None and column is not None:
        file_path, line = import_msg.get_msg(line)
        msg = '[Debug] file "' + file_path + '", line ' + str(line) + ':' + str(column) + ', ' + msg
    logging.debug(msg)
...
def LOG_INFO(msg, token=None, line=None, column=None):
    if token is not None:
        file_path, line = import_msg.get_msg(token.line)
        msg = '[Info] file "' + file_path + '", line ' + str(line) + ':' + str(token.column) + ', ' + msg
    elif line is not None and column is not None:
        file_path, line = import_msg.get_msg(line)
        msg = '[Info] file "' + file_path + '", line ' + str(line) + ':' + str(column) + ', ' + msg
    logging.info(msg)
...
def LOG_WARNING(msg, token=None, line=None, column=None):
    ...
    if token is not None:
        file_path, line = import_msg.get_msg(token.line)
        run_log_msg = '[Warning]' + ' line ' + str(line) + ':' + str(token.column) + ', ' + msg
        msg = '[Warning] file "' + file_path + '", line ' + str(line) + ':' + str(token.column) + ', ' + msg
    elif line is not None and column is not None:
        file_path, line = import_msg.get_msg(line)
        run_log_msg = '[Warning]' + ' line ' + str(line) + ':' + str(column) + ', ' + msg
        msg = '[Warning] file "' + file_path + '", line ' + str(line) + ':' + str(column) + ', ' + msg
...
def LOG_ERROR(msg, token=None, line=None, column=None):
    ...
    if token is not None:
        file_path, line = import_msg.get_msg(token.line)
        run_log_msg = '[Error]' + ' line ' + str(line) + ':' + str(token.column) + ', ' + msg
        msg = '[Error] file "' + file_path + '", line ' + str(line) + ':' + str(token.column) + ', ' + msg
    elif line is not None and column is not None:
        file_path, line = import_msg.get_msg(line)
        run_log_msg = '[Error]' + ' line ' + str(line) + ':' + str(column) + ', ' + msg
        msg = '[Error] file "' + file_path + '", line ' + str(line) + ':' + str(column) + ', ' + msg
